...
import { EditTeacherListingWizard, NamedRedirect, Page } from '../../components';
...
export const EditTeacherListingPageComponent = props => {
  const {
    currentUser,
  ...
  if (shouldRedirect) {
    ...
    const title = isNewListingFlow
      ? intl.formatMessage({ id: 'EditTeacherListingPage.titleCreateListing' })
      : intl.formatMessage({ id: 'EditTeacherListingPage.titleEditListing' });
...
EditTeacherListingPageComponent.defaultProps = {
...
const EditTeacherListingPage = compose(
  withRouter,
  connect(
    mapStateToProps,
    mapDispatchToProps
  )
)(injectIntl(EditTeacherListingPageComponent));

EditTeacherListingPage.loadData = loadData;

export default EditTeacherListingPage;
