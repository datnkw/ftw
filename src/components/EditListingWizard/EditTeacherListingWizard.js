...
import EditTeacherListingWizardTab, {
  GENERAL,
  TEACHER_LOCATION,
  TEACHER_PRICING,
...
const tabLabel = (intl, tab) => {
  let key = null;
  if (tab === GENERAL) {
    key = 'EditTeacherListingWizard.tabLabelGeneral';
  } else if (tab === TEACHER_LOCATION) {
...
class EditTeacherListingWizard extends Component {
  constructor(props) {
    super(props);
...
EditTeacherListingWizard.defaultProps = {
  className: null,
  currentUser: null,
  rootClassName: null,
  listing: null,
